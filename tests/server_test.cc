...
class ServerTest : public ::testing::Test {
  protected:
    ...
    server server_ = server(io_service_, acceptor, response_builder_,
        [](boost::asio::io_service& io_service_, ResponseBuilder& response_builder_) -> session* {
    ...
    void start_() {
        return server_.start_accept();
    }
    
    void accept_() {
        session* new_session = server_.make_session_(io_service_, response_builder_);
